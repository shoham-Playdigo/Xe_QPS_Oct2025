...
# --- START: EXCLUSION SETUP FIXES ---

# New: Exclusions by ID. Reads the variable EXCLUDED_dsp_id from the workflow.
EXCLUDED_IDS = {
    int(x.strip())
...
        # --- START: COMBINED EXCLUSION CHECK FIX ---
        is_excluded = False
        reason_text = ""
        
...
            })
            continue
        # --- END: COMBINED EXCLUSION CHECK FIX ---
